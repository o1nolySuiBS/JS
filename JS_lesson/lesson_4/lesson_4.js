...
function cylinder(r, h) {
    let aboba = h + r
    return 2 * 3.14 * r * aboba
}

let r3 = cylinder(4, 7)
console.log('cylinder: ', r3)
...
function ElementCather(element) {
    document.write(`<ul>`)
